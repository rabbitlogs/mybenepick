...
일하면서 아이를 키우는 부모를 위한 제도가 2026년에 한 번 더 넓어져요. ==육아휴직 대상 자녀가 만 8세에서 만 12세로 확대되고, 사용 기간도 1년에서 1년 6개월로 늘어나요.== 급여의 25%를 복직 후에야 받을 수 있던 사후지급금 제도는 이미 폐지된 상태라, 매달 전액을 그대로 받을 수 있어요.

> 📌 3줄 요약
>
> 1. 육아휴직 대상 자녀 만 8세 → 만 12세로 확대, 기간 1년 → 1년 6개월로 연장
...
<strong class="key">사용 기간</strong>: 부모 각각 1년 → 1년 6개월(부부합산 최대 3년)
<strong class="key">분할 사용</strong>: 최대 3회(총 4기간)까지 나눠서 사용 가능
<strong class="key">방학 단기 휴직</strong>: 2026년 7월부터 만 8세 이하 자녀 대상 연 1회 신설
[[/SUMMARY]]

기간이 1년 6개월로 늘면서, 부부가 각각 다 사용하면 합산 최대 3년까지 육아휴직을 쓸 수 있어요. 분할 사용도 최대 3회(총 4기간)로 늘어나서, 예를 들어 3개월+6개월+3개월+6개월처럼 필요한 시기에 나눠 쓸 수 있어요. 다만 분할 사용할 때마다 회사에 다시 신청해야 해요.
